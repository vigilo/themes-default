...
var babelThemes = new function() {
  ...
  Translations.prototype = {
     ...
     * three new methods on the window object: l_, lgettext and lngettext
     */
    install: function() {
      var self = this;
      window.l_ = window.lgettext = function(string) {
        return self.gettext(string);
      };
      window.lngettext = function(singular, plural, n) {
