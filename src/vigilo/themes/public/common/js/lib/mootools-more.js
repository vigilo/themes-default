...
Drag.Move = new Class({
    ...
    calculateLimit: function(){
        /**
            fpoirott: la partie "|| document.body" est nécessaire si l'élément
            a un container (cf. options) car getOffsetParent() retourne null
            dans ce cas. Le correctif est basé sur les remarques dans :
            - https://github.com/mootools/mootools-more/issues/issue/48
            - https://github.com/mootools/mootools-more/issues/issue/72
        */
        var offsetParent = this.element.getOffsetParent() || document.body,
